...
export default class User extends Component {
  ...
  componentWillMount(){
    this._panResponder = PanResponder.create({
      ...
      //Ativa o PanResponder em qualquer gesto de arrastar do usuário
      onMoveShouldSetPanResponder: () => true, 

      //Valor que será alterado com o PanResponder
      onPanResponderMove: Animated.event([null, {
        dx: this.state.offset.x,
      }]),

      // Quando o usuario solta a View
      ...
      //Quando o panResponder terminar, volta pra posição inicial
